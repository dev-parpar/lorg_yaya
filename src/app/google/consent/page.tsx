...
export default function GoogleConsentPage() {
  ...
  const handleAllow = useCallback(async () => {
    ...
    try {
      const res = await fetch("/api/google/auth/link", {
        method: "POST",
      ...
      <div className="min-h-screen flex items-center justify-center bg-background p-4">
        <Card className="w-full max-w-md">
          <CardHeader>
            ...
            <CardDescription>
              This page should only be accessed through the Google account linking flow.
            </CardDescription>
          </CardHeader>
        </Card>
      </div>
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          ...
          <CardDescription className="text-center">
            {isLoggedIn
              ? "Google Assistant wants to access your Lorgy inventory"
              : "Sign in to link your Lorgy account with Google Assistant"}
          </CardDescription>
        </CardHeader>
          ...
          {!isLoggedIn ? (
            ...
            <div className="space-y-6">
              <div className="rounded-md border p-4 space-y-2">
                <p className="text-sm font-medium">Google Assistant will be able to:</p>
